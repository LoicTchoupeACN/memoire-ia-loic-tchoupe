...
\includepdf[pages=-]{0_page_de_garde/page_de_garde.pdf}
...
\fancyhead[R]{\includegraphics[height=1.6cm]{images/euria_logo.png}}   % Logo ISFA à droite
...
\titleformat{\chapter}[display]
  ...
  {\vspace*{5pt}\chaptertitlename\ \thechapter} 
  {5pt} 
  {\Huge} 
